...
const STATIC_ASSETS = [
  ...
  './css/deepening-mode.css?v=215',
  './css/deepening-shell.css?v=215',
  './css/meditation-document-viewer.css?v=215',
  './css/meditation-actions-panel.css?v=215',
  './js/NotebookGestureController.js?v=215',
  './js/app.js?v=215',
  './js/ReadingPositionManager.js?v=215',
  './js/ReadingDocument.js?v=215',
  './js/DocumentFactory.js?v=215',
  './js/DocumentExporter.js?v=215',
  './js/PdfDocumentBuilder.js?v=215',
  './js/PdfExporter.js?v=215',
  './js/ShareService.js?v=215',
  './js/MeditationDocumentViewer.js?v=215',
  './js/MeditationActionsPanel.js?v=215',
  './js/MeditationDocument.js?v=215',
  './js/KeyboardManager.js?v=215',
  './js/DeepeningShell.js?v=215',
  './js/utils/dompurify.min.js?v=215',
  './js/communityIdentity.js?v=215',
  './js/avatarGenerator.js?v=215',
  './js/richTextEditor.js?v=215',
  './js/voiceReflections.js?v=215',
  './js/liveFeed.js?v=215',
  './js/moderation.js?v=215',
  './js/userMetrics.js?v=215',
  './js/notifications.js?v=215',
  './js/performance.js?v=215',
  './js/accessibility.js?v=215',
  './js/i18n.js?v=215',
  './js/toastManager.js?v=215',
  './js/communityAnalytics.js?v=215',
  './js/searchCommunity.js?v=215',
  './js/filters.js?v=215',
  './js/offlineSupport.js?v=215',
