...
const STATIC_ASSETS = [
  ...
  './index.html',
  './manifest.json?v=231',
  './css/styles.css?v=231',
  './css/deepening-mode.css?v=231',
  './css/deepening-shell.css?v=231',
  './css/meditation-document-viewer.css?v=231',
  './css/meditation-actions-panel.css?v=231',
  './js/NotebookGestureController.js?v=231',
  './js/app.js?v=231',
  './js/ReadingPositionManager.js?v=231',
  './js/ReadingDocument.js?v=231',
  './js/DocumentFactory.js?v=231',
  './js/DocumentExporter.js?v=231',
  './js/PdfDocumentBuilder.js?v=231',
  './js/PdfExporter.js?v=231',
  './js/ShareService.js?v=231',
  './js/MeditationDocumentViewer.js?v=231',
  './js/MeditationActionsPanel.js?v=231',
  './js/MeditationDocument.js?v=231',
  './js/KeyboardManager.js?v=231',
  './js/DeepeningShell.js?v=231',
  './js/utils/dompurify.min.js?v=231',
  './js/communityIdentity.js?v=231',
  './js/avatarGenerator.js?v=231',
  './js/richTextEditor.js?v=231',
  './js/voiceReflections.js?v=231',
  './js/liveFeed.js?v=231',
  './js/moderation.js?v=231',
  './js/userMetrics.js?v=231',
  './js/notifications.js?v=231',
  './js/performance.js?v=231',
  './js/accessibility.js?v=231',
  './js/i18n.js?v=231',
  './js/toastManager.js?v=231',
  './js/communityAnalytics.js?v=231',
  './js/searchCommunity.js?v=231',
  './js/filters.js?v=231',
  './js/offlineSupport.js?v=231',
