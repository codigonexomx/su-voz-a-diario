...
const STATIC_ASSETS = [
  ...
  './css/deepening-mode.css?v=214',
  './css/deepening-shell.css?v=214',
  './css/meditation-document-viewer.css?v=214',
  './css/meditation-actions-panel.css?v=214',
  './js/NotebookGestureController.js?v=214',
  './js/app.js?v=214',
  './js/ReadingPositionManager.js?v=214',
  './js/ReadingDocument.js?v=214',
  './js/DocumentFactory.js?v=214',
  './js/DocumentExporter.js?v=214',
  './js/PdfDocumentBuilder.js?v=214',
  './js/PdfExporter.js?v=214',
  './js/ShareService.js?v=214',
  './js/MeditationDocumentViewer.js?v=214',
  './js/MeditationActionsPanel.js?v=214',
  './js/MeditationDocument.js?v=214',
  './js/KeyboardManager.js?v=214',
  './js/DeepeningShell.js?v=214',
  './js/utils/dompurify.min.js?v=214',
  './js/communityIdentity.js?v=214',
  './js/avatarGenerator.js?v=214',
  './js/richTextEditor.js?v=214',
  './js/voiceReflections.js?v=214',
  './js/liveFeed.js?v=214',
  './js/moderation.js?v=214',
  './js/userMetrics.js?v=214',
  './js/notifications.js?v=214',
  './js/performance.js?v=214',
  './js/accessibility.js?v=214',
  './js/i18n.js?v=214',
  './js/toastManager.js?v=214',
  './js/communityAnalytics.js?v=214',
  './js/searchCommunity.js?v=214',
  './js/filters.js?v=214',
  './js/offlineSupport.js?v=214',
