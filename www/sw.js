...
const STATIC_ASSETS = [
  ...
  './index.html',
  './manifest.json?v=230',
  './css/styles.css?v=230',
  './css/deepening-mode.css?v=230',
  './css/deepening-shell.css?v=230',
  './css/meditation-document-viewer.css?v=230',
  './css/meditation-actions-panel.css?v=230',
  './js/NotebookGestureController.js?v=230',
  './js/app.js?v=230',
  './js/ReadingPositionManager.js?v=230',
  './js/ReadingDocument.js?v=230',
  './js/DocumentFactory.js?v=230',
  './js/DocumentExporter.js?v=230',
  './js/PdfDocumentBuilder.js?v=230',
  './js/PdfExporter.js?v=230',
  './js/ShareService.js?v=230',
  './js/MeditationDocumentViewer.js?v=230',
  './js/MeditationActionsPanel.js?v=230',
  './js/MeditationDocument.js?v=230',
  './js/KeyboardManager.js?v=230',
  './js/DeepeningShell.js?v=230',
  './js/utils/dompurify.min.js?v=230',
  './js/communityIdentity.js?v=230',
  './js/avatarGenerator.js?v=230',
  './js/richTextEditor.js?v=230',
  './js/voiceReflections.js?v=230',
  './js/liveFeed.js?v=230',
  './js/moderation.js?v=230',
  './js/userMetrics.js?v=230',
  './js/notifications.js?v=230',
  './js/performance.js?v=230',
  './js/accessibility.js?v=230',
  './js/i18n.js?v=230',
  './js/toastManager.js?v=230',
  './js/communityAnalytics.js?v=230',
  './js/searchCommunity.js?v=230',
  './js/filters.js?v=230',
  './js/offlineSupport.js?v=230',
