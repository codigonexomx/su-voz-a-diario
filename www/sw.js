...
const STATIC_ASSETS = [
  './js/utils/bibleIcons.js',
  './js/services/DeepLinkService.js',
  './',
  './index.html',
  './manifest.json?v=254',
  './css/styles.css?v=254',
  './css/deepening-mode.css?v=254',
  './css/deepening-shell.css?v=254',
  './css/meditation-document-viewer.css?v=254',
  './css/meditation-actions-panel.css?v=254',
  './js/NotebookGestureController.js?v=254',
  './js/app.js?v=254',
  './js/ReadingPositionManager.js?v=254',
  './js/ReadingDocument.js?v=254',
  './js/DocumentFactory.js?v=254',
  './js/DocumentExporter.js?v=254',
  './js/PdfDocumentBuilder.js?v=254',
  './js/PdfExporter.js?v=254',
  './js/ShareService.js?v=254',
  './js/MeditationDocumentViewer.js?v=254',
  './js/MeditationActionsPanel.js?v=254',
  './js/MeditationDocument.js?v=254',
  './js/KeyboardManager.js?v=254',
  './js/DeepeningShell.js?v=254',
  './js/utils/dompurify.min.js?v=254',
  './js/communityIdentity.js?v=254',
  './js/avatarGenerator.js?v=254',
  './js/richTextEditor.js?v=254',
  './js/voiceReflections.js?v=254',
  './js/liveFeed.js?v=254',
  './js/moderation.js?v=254',
  './js/userMetrics.js?v=254',
  './js/notifications.js?v=254',
  './js/performance.js?v=254',
  './js/accessibility.js?v=254',
  './js/i18n.js?v=254',
  './js/toastManager.js?v=254',
  './js/communityAnalytics.js?v=254',
  './js/searchCommunity.js?v=254',
  './js/filters.js?v=254',
  './js/offlineSupport.js?v=254',
  ...
  './js/bible/ContinuousReader.js',
  './js/bible/FootnotesRepository.js',
  './js/bible/RemoteBibleProvider.js',
  './js/services/AnalyticsService.js',
  './js/services/storageService.js',
  './js/NotebookStorage.js',
  './js/NotebookUIStateStorage.js',
  './js/NotebookAnalytics.js',
  './js/services/JourneyService.js',
  './js/JourneyView.js',
  './js/MeditationSessionStorage.js',
  './js/MeditationSessionUIStateStorage.js',
  './js/MeditationLibrary.js',
  './js/utils/dates.js',
  './js/utils/dom.js',
  ...
  './data/readings/2026-09.json',
  './data/readings/2026-10.json',
  './data/readings/2026-11.json',
  './data/readings/2026-12.json',
  './data/rv1909.json',
  './data/section-headings-español.json',
  './data/footnotes-espanol-rv1909-FINAL.json',
  './imagendefondo.png',
  './icons/icon-48.png',
  './icons/icon-180.png',
  './icons/icon-192.png',
