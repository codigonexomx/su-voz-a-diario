...
const STATIC_ASSETS = [
  ...
  './css/deepening-mode.css?v=156',
  './css/deepening-shell.css?v=156',
  './css/meditation-document-viewer.css?v=156',
  './css/meditation-actions-panel.css?v=156',
  './js/NotebookGestureController.js?v=156',
  './js/app.js?v=156',
  './js/ReadingPositionManager.js?v=156',
  './js/ReadingDocument.js?v=156',
  './js/DocumentFactory.js?v=156',
  './js/DocumentExporter.js?v=156',
  './js/PdfDocumentBuilder.js?v=156',
  './js/PdfExporter.js?v=156',
  './js/ShareService.js?v=156',
  './js/MeditationDocumentViewer.js?v=156',
  './js/MeditationActionsPanel.js?v=156',
  './js/MeditationDocument.js?v=156',
  './js/KeyboardManager.js?v=156',
  './js/DeepeningShell.js?v=156',
