...
const NotebookGestureController = (function() {
    ...
    function init(panelElement, headerElement) {
        ...
        if (boundPanel === panelElement && boundHeader === headerElement) {
            panel = panelElement;
        ...
        if (boundHeader) {
            boundHeader.removeEventListener('touchstart', onTouchStart);
        }

        if (boundPanel) {
            boundPanel.removeEventListener('transitionend', onTransitionEnd);
        }

        panel = panelElement;
        header = headerElement;
        boundPanel = panelElement;
        boundHeader = headerElement;
